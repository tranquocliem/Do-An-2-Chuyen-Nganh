...
function CreateProfile(props) {
  ...
  // const [skillAndHobby, setSkillAndHobby] = useState({ skill: "", hobby: "" });
  ...
  //   const newLength = { ...length };
  //   newLength[e.target.name] = e.target.value.length;
  //   const newSkillAndHobby = { ...skillAndHobby };
  //   newSkillAndHobby[e.target.name] = e.target.value;

  //   setLength(newLength);
  //   setSkillAndHobby(newSkillAndHobby);
  // };
  ...
  // const tmp = "- Thích mùa đông và ghét mùa hè.↵ - Thích đi du lịch nhiều nơi.";
  // const str = tmp.replace("↵", "<br />");
