...
//load tài khoản không pagination
adminRouter.get(
  "/getAccountAll",
  passport.authenticate("jwt", { session: false }),
  (req, res) => {
...
//load danh sách tuyển dụng theo ngày đăng mới nhất đã phê duyệt có pagination
adminRouter.get(
  "/getRecruitmentTrue",
  passport.authenticate("jwt", { session: false }),
  (req, res) => {
...
//load danh sách tuyển dụng theo ngày đăng củ nhất chưa phê duyệt có pagination
adminRouter.get(
  "/getRecruitmentFalse",
  passport.authenticate("jwt", { session: false }),
  (req, res) => {
...
//cập nhật trang thái tin tuyển dụng
adminRouter.post(
